...
The application was built and tested using AWS services connected together in a working serverless pipeline.

### Dashboard

The web dashboard allows a user to select an image and upload it for analysis.

![Dashboard](screenshots/dashboard.png)

### AI Analysis Results

After processing, the dashboard displays results generated by Amazon Rekognition and Amazon Bedrock.
